...
# (PFM frozen -> PFM-RFT role encoder only -> PFM-FT end to end); SuTraN = red;
# FM-v2 = yellow-green, kept clear of the turquoise ramp.
COL = {"PFM": "#7ecfcf", "PFM-RFT": "#2ba3a8", "PFM-FT": "#0f6470", "SuTraN": "#d62728",
       "FM-v2 Proto": "#4d8b1f", "FM-v2 kNN": "#a8cf5c"}
BAR_METHODS = ["PFM", "PFM-RFT", "PFM-FT", "SuTraN", "FM-v2 Proto", "FM-v2 kNN"]
